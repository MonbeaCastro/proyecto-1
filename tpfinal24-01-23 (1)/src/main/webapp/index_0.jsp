...
<body>
    ...
    <%
        ...
        String pago_total    =request.getParameter("txt_Pago_total");
            ...
            <form name="ticketsForm" id="ticketsForm" action="">
                ...
                <div class="tickets-form">
                    ...
                    <div class="labelTicketsQuantity">
                        ...
                        <input id="txt_Cantidad" value="1" type="text" class="ticketsQuantity" name="txt_Cantidad"
                    ...
                    Total a pagar: <input type="Text" class="ticketsValue" id="totalapagar" name="totalapagar"> 
